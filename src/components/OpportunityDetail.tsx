...
const OpportunityDetail: FC<OpportunityDetailProps> = ({ data }) => {
  ...
  return (
    <div className="min-h-screen bg-white relative font-poppins mx-auto pb-24 md:pb-20">
      {/* Mobile Header */}
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4 lg:py-6 relative">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 h-64 md:h-80 lg:h-96 rounded-xl overflow-hidden">
              {/* Main Image */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 relative">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-2">
                {skills.map((skill: string, index: number) => (
                  <div
                    key={index}
                    className="bg-yellow-100 text-yellow-800 px-3 py-2 rounded-lg text-sm font-medium text-center truncate"
                  >
                    {skill}
                  </div>
                ))}
          ...
          <div className="lg:col-span-1 relative">
            ...
            <div className="hidden lg:block bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <div className="border-gray-300 border-b pb-6">
            ...
            <div className="mt-2 space-y-3 text-sm md:text-base">
              <p className="font-light opacity-80 font-sans leading-relaxed">
                I&apos;m looking for a dedicated volunteer to join us, who can enhance
                our guest relations and support property operations. Ideally, this
                person should have a warm and welcoming demeanor, ensuring that
                every guest feels valued and at home in our serene setting.
              </p>
              <p className="font-light opacity-80 font-sans leading-relaxed">
                Your role will involve engaging with guests, assisting with
                check-ins, and providing them with information about the area and
                activities available. We hope you can create a positive atmosphere
                by fostering connections among guests and encouraging them to
              ...
              <p className="font-light opacity-80 font-sans leading-relaxed">
                ...
                contributions will help us maintain the property&apos;s charm and
                comfort.
              </p>
              <p className="font-light opacity-80 font-sans leading-relaxed">
                We&apos;re seeking someone who is proactive, adaptable, and
                enthusiastic about creating memorable experiences. If you&apos;re
                passionate about nature, hospitality.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 text-custom-green font-poppins">
            ...
            <div className="lg:col-span-2 border border-gray-300 rounded-2xl flex flex-col sm:flex-row lg:flex items-center justify-around shadow-lg p-6 lg:p-4">
              <div className="flex flex-col text-center justify-around mb-4 sm:mb-0 lg:mb-4">
                <img className="h-16 md:h-20 lg:h-24 mx-auto mb-2" src="/Group.svg" alt="" />
              ...
              <div className="flex sm:flex-col gap-4 sm:gap-0 text-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs font-poppins text-center">Years of Hosting</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 flex flex-col justify-center space-y-4">
              ...
              <p className="font-poppins opacity-80 text-sm md:text-base leading-relaxed">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam velit non fuga aliquam iure, vero dolorum quidem blanditiis esse deserunt asperiores suscipit. Necessitatibus 
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Fixed Bottom Bar */}
      <div className="fixed bottom-0 left-0 right-0 z-10 bg-white border-t border-gray-200 px-4 py-3 shadow-lg">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex flex-wrap justify-between sm:justify-start gap-2 sm:gap-4 lg:gap-6 text-xs sm:text-sm lg:text-base">
              ...
              <div className="flex items-center gap-1">
                <img src="/home.svg" className="w-4 h-4 sm:w-5 sm:h-5" alt="Accommodation" />
                <span>Hostel</span>
              </div>
            ...
            <Button
              className="w-full sm:w-auto bg-custom-green hover:bg-teal-700 text-white text-sm sm:text-lg font-semibold rounded-full px-6 sm:px-8 py-2 sm:py-3"
            >
              APPLY NOW
            </Button>
          </div>
